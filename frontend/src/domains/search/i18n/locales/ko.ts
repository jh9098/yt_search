...
export const SEARCH_UI_TEXT_KO: SearchUiText = {
  ...
  searchResultTable: {
    tableAriaLabel: "검색 결과 테이블",
    columns: {
      title: "제목",
      channelName: "채널",
      publishedDateText: "영상 게시일",
      viewCount: "조회수",
      subscriberCount: "구독자",
      channelPublishedDateText: "채널 개설일",
      totalVideoCount: "총 영상 수",
      subscriptionRate: "구독률",
      annualSubscriberGrowth: "연간 성장",
      uploadsPerWeek: "업로드 빈도",
      countryCode: "국가",
      channelGrade: "등급",
